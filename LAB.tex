...
\begin{figure}[htpb]
    ...
    \caption{Esquematização da hierarquia dos módulos de software.}
...
\begin{figure}[htpb]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        \caption{Matriz gerada pelo \texttt{tabuleiro.py}. A hashtag delimita as peças físicas e serve como obstáculo para o algoritmo de caminho.}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
...
\begin{figure}[htpb]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        \caption{Esquematização final para soldagem.}
    \end{subfigure}
...
\begin{itemize}
    \item \textbf{Problema de Instabilidade Rotacional:} A primeira iteração contava com um rolamento no braço superior do carrinho e um no braço inferior. Sob ação da tração da correia, o conjunto sofria deflexão angular e girava facilmente sobre o trilho, travando o sistema. A solução foi redesenhar o carrinho adicionando um segundo rolamento de estabilização na face superior.(Figura \ref{fig:novo_carrinho}).
...
\begin{itemize}
    \item \textbf{Área Total:} Estrutura externa em MDF de $400 \times 400 \times 6\,\text{mm}$. Superfície superior composta por uma chapa de acrílico translúcido de 3mm, permitindo a visualização interna dos eixos em operação.
...
\begin{enumerate}
    ...
    \item Implementação de um sistema de detecção de fim de curso para habilitar rotinas automáticas de calibração;
